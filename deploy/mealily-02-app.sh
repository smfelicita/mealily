...
UNISENDER_GO_API_KEY="$(getv UNISENDER_GO_API_KEY /root/.mealily/old-backend.env)"
MAIL_FROM="$(getv MAIL_FROM /root/.mealily/old-backend.env)"
...
echo "Ключи получены (anthropic, unisender, google, supabase)"
...
MAIL_FROM="${MAIL_FROM:-Meality <noreply@mealily.ru>}"
