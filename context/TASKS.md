...
Добавлены токены в `@theme {}`: `--text-2xs` (11px), `--text-xl2` (19px), `--text-2xl2` (22px), `--text-3xl2` (26px).
Уже были: `--text-sm2` (13px), `--text-md2` (15px), `--text-lg2` (17px).
Заменены все `text-[Xpx]` с 11–26px во всех 39 файлах фронтенда.
Осталось за рамками: `text-[10px]` (5), `text-[12px]` (32), `text-[32/40/48px]` (4) — намеренные крайние случаи.
