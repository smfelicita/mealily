...
Управление поведением без деплоя.
- Таблица `FeatureFlag` в БД (key, value, description)
- Флаги: лимиты ИИ по роли, включить/выключить ИИ, скрыть онбординг, режим обслуживания
- Фронт читает флаги при старте через API
- UI в админке: список флагов, редактирование значений
