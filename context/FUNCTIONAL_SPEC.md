# Meality — Функциональная спецификация
...
| ИИ-чат (user) | 10 сообщений/день | по DB |
| ИИ-чат (pro) | 100 сообщений/день | по DB |
...
- Название (nameRu)
- Описание
- Категория (MealCategory): SOUP / SALAD / MAIN / SIDE / DESSERT / DRINK / BAKERY / SAUCE
- Время приёма пищи (MealType): BREAKFAST / LUNCH / DINNER / SNACK / ANYTIME
- Кухня (cuisine)
...
- **ИИ-чат: скрыт только в боте** (кнопка убрана из меню, код закомментирован — бэклог)
...
> REGULAR-группы работают в полном объёме — и в UI, и на бэкенде.
